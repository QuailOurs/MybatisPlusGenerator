...
public class App
{
    ...
    private static void placeComponents(JPanel panel) {
        ...
        outputDirLabel.setBounds(10,getInterval(),250,25);
        ...
        usernameText.setBounds(100,getInterval(),250,25);
        panel.add(usernameText);
        usernameText.setText("root");

        JLabel passwordLabel = new JLabel("密码:");
        passwordLabel.setBounds(10,getInterval(),250,25);
        ...
        includetablenameLabel.setBounds(10,getInterval(),250,25);
        panel.add(includetablenameLabel);

        final JTextField includeTablenameText = new JTextField(20);
        includeTablenameText.setBounds(100,getInterval(),250,25);
        ...
        button.addActionListener(e -> {
            ...
            String dbType = Objects.requireNonNull(dbTypeCombo.getSelectedItem()).toString();
            String driverName = Objects.requireNonNull(driverNameCombo.getSelectedItem()).toString();
